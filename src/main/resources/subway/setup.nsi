...
!define PRODUCT_VERSION  "6.1.0.18(x64)"
!define FILE_VERSION     "6.1.0.18(x64)"
...
Function addEnvironment
	...
	WriteRegExpandStr HKLM "SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "Path" "$INSTDIR\jdk\bin;$0" 
	;TIMEOUT 
